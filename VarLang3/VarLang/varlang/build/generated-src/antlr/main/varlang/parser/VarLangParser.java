...
public class VarLangParser extends Parser {
	...
	public final ExpContext exp() throws RecognitionException {
		...
		try {
			...
			case 9:
				...
				{
				setState(46);
				((ExpContext)_localctx).dec = decexp();
				 ((ExpContext)_localctx).ast =  ((ExpContext)_localctx).dec.ast; 
				}
				break;
			}
		}
	...
	public final DecexpContext decexp() throws RecognitionException {
		...
		try {
			...
			match(Dec);
			setState(93);
			((DecexpContext)_localctx).key = exp();
			setState(94);
			((DecexpContext)_localctx).body = exp();
			setState(95);
			match(T__1);
			 ((DecexpContext)_localctx).ast =  new DecExp(((DecexpContext)_localctx).body.ast, ((DecexpContext)_localctx).key.ast); 
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
